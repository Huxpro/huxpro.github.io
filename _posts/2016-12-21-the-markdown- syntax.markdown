---
layout:     post
title:      "使用jekyll在github pages搭建博客时的markdowm语法问题"
subtitle:   "The markdown syntax"
date:       2016-12-21
author:     "Alex"
...
在搭建好自己的blog之后（是的，花了我很久时间），发现自己没有掌握markdowm语法，写出来的文章排版啊美观程度什么的跟黄玄大神差远了，是时候不断总结一下markdowm语法了！
...
根据黄玄大神的[README](https://github.com/Huxpro/huxpro.github.io/blob/master/README.zh.md):
...
官方说明：http://jekyllrb.com/docs/posts/#highlighting-code-snippets 

将你的代码放在 **% highlight ruby %**和**%endhighlight %**之间，分别用大括号括起来
...
https://www.zhihu.com/question/21198746

不同的代码高亮插件也需要不同的编译代码，高亮插件也就是JS查找HTML中特定的节点，并对特定节点赋予特定css，而css的结果也就是给代码上色；所以纯粹说代码高亮的话就与Jekyll无关了，在这里要说的是Jekyll＋MD文件＋CODE 的方式。
...
js可以换成其他语言，比如C，但是我试了一下Python，好像不可以
