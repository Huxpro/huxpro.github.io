...
- implementation **refers** to [Luong (2016)](https://github.com/lmthang/thesis)
  ...
  - **example** of a deep recurrent architecture for translating a source sentence "I am a student" into a target sentence "Je suis étudiant". Here, \<s\> marks the start of the decoding process while \</s\> tells the decoder to stop. 
...
- **training data prepare**: *source sentence + boundary marker \<s\> + target sentence*
