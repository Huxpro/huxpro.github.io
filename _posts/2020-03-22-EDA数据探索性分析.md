...
- `pd.info` 通过info来了解数据每列的type，有助于了解是否存在除了nan以外的特殊符号异常
...
<p align="center">
  <img src="https://gitee.com/echisenyang/GiteeForUpicUse/raw/master/uPic/07J2mJ.jpg" style="zoom:50%" />
</p>
...
<p align="center">
  <img src="https://gitee.com/echisenyang/GiteeForUpicUse/raw/master/uPic/pPlzvE.jpg" style="zoom:50%" />
</p>

  `msno.bar(Train_data.sample(1000))`

<p align="center">
  <img src="https://gitee.com/echisenyang/GiteeForUpicUse/raw/master/uPic/KzsJmX.jpg" style="zoom:50%" />
</p>

- 查看异常值检测：可以看出来‘ - ’也为空缺值，因为很多模型对nan有直接的处理，这里我们先不做处理，先替换成nan

  `Train_data['notRepairedDamage'].value_counts()` 使用value_count函数查看数据情况
  ...
  `pd.is_null()`结合`pd.isnull().sum()` 查看数据缺失情况

- 以下两个类别特征严重倾斜，一般不会对预测有什么帮助，故这边先删掉

<p align="center">
  <img src="https://gitee.com/echisenyang/GiteeForUpicUse/raw/master/uPic/uPeADc.jpg" style="zoom:50%" />
</p>
...
<p align="center">
<img src="https://gitee.com/echisenyang/GiteeForUpicUse/raw/master/uPic/kTKwrg.jpg" style="zoom:50%" />
</p>

<p align="center">
<img src="https://gitee.com/echisenyang/GiteeForUpicUse/raw/master/uPic/x8MJbR.jpg" style="zoom:50%" />
</p>
...
<p align="center">
<img src="https://gitee.com/echisenyang/GiteeForUpicUse/raw/master/uPic/piHGFc.jpg" style="zoom:50%" />
</p>
...
<p align="center">
<img src="https://gitee.com/echisenyang/GiteeForUpicUse/raw/master/uPic/coe62p.jpg" style="zoom:50%" />
</p>

  - 处理方法：查看频数, 大于20000得值极少，其实这里也可以把这些当作特殊得值（异常值）直接用填充或者删掉。也可以进行log变换进行预测，这也是预测问题常用的trick。

<p align="center">
<img src="https://gitee.com/echisenyang/GiteeForUpicUse/raw/master/uPic/OL1y5X.jpg" style="zoom:50%" />
</p>
...
- 类别特征：`categorical_features = ['name', 'model', 'brand', 'bodyType', 'fuelType', 'gearbox', 'notRepairedDamage', 'regionCode',]`
  ...
  | **Field**         |                       **Description**                        | 数据情况      |
  | ----------------- | :----------------------------------------------------------: | ------------- |
  | name              | <img src="https://gitee.com/echisenyang/GiteeForUpicUse/raw/master/uPic/2PLOET.jpg" style="zoom:30%;" /> | 99662个不同值 |
  | model             | <img src="https://gitee.com/echisenyang/GiteeForUpicUse/raw/master/uPic/Ixfdl5.jpg" style="zoom:30%;" /> | 248个不同值   |
  | brand             | <img src="https://gitee.com/echisenyang/GiteeForUpicUse/raw/master/uPic/g3kVCr.jpg" style="zoom:30%;" /> | 40不同的值    |
  | bodyType          | <img src="https://gitee.com/echisenyang/GiteeForUpicUse/raw/master/uPic/7LGEDl.jpg" style="zoom:30%;" /> | 8不同的值     |
  | fuelType          | <img src="https://gitee.com/echisenyang/GiteeForUpicUse/raw/master/uPic/6PfKJR.jpg" style="zoom:30%;" /> | 7不同的值     |
  | gearbox           | <img src="https://gitee.com/echisenyang/GiteeForUpicUse/raw/master/uPic/sezQfi.jpg" style="zoom:30%;" /> | 2不同的值     |
  | regionCode        | <img src="https://gitee.com/echisenyang/GiteeForUpicUse/raw/master/uPic/T3muml.jpg" style="zoom:30%;" /> | 7905不同的值  |
...
<p align="center">
<img src="https://gitee.com/echisenyang/GiteeForUpicUse/raw/master/uPic/urG7yq.jpg" style="zoom:40%" />
</p>
...
<p align="center">
<img src="https://gitee.com/echisenyang/GiteeForUpicUse/raw/master/uPic/uZOCLt.jpg" style="zoom:50%" />
</p>

<p align="center">
<img src="https://gitee.com/echisenyang/GiteeForUpicUse/raw/master/uPic/sN5O5i.jpg" style="zoom:50%" />
</p>

<p align="center">
<img src="https://gitee.com/echisenyang/GiteeForUpicUse/raw/master/uPic/0ispcP.jpg" style="zoom:50%" />
</p>
...
<p align="center">
<img src="https://gitee.com/echisenyang/GiteeForUpicUse/raw/master/uPic/DEHKdT.jpg" style="zoom:100%" />
</p>
...
<p align="center">
  <img src="https://gitee.com/echisenyang/GiteeForUpicUse/raw/master/uPic/4dBK3Z.jpg" style="zoom:100%" />
</p>
...
- 类别特征箱形图可视化
  ...
  <p align="center">
  <img src="https://gitee.com/echisenyang/GiteeForUpicUse/raw/master/uPic/jV8msJ.jpg" style="zoom:100%" />
  </p>
