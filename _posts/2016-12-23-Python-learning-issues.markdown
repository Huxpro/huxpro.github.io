...
subtitle:   "那些年，我在通往Python之路上趟过的坑"
date:       2016-12-23
author:     "Alex"
...
在一个人入门「Python的路上遇到了好多坑」，我把他们一一写下来吧。或许还能够给后来人一些帮助呢。
...
> Could not fetch URL https://pypi.python.org/simple/beautifulsoup/: There was a problem confirming the ssl certificate: [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed (_ssl.c:645) - skipping
...
在`stackoverflow`上找到了相同的问题，[pip issue installing almost any library](http://stackoverflow.com/questions/16370583/pip-issue-installing-almost-any-library) 。

相关问题：
* [pip install fails with “connection error: [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed (_ssl.c:598)”](http://stackoverflow.com/questions/25981703/pip-install-fails-with-connection-error-ssl-certificate-verify-failed-certi?noredirect=1&lq=1)
* [python easy_install fails with SSL certificate error for all packages](http://stackoverflow.com/questions/21265616/python-easy-install-fails-with-ssl-certificate-error-for-all-packages?noredirect=1&lq=1)
