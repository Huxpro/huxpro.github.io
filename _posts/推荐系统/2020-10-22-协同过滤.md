...
- **余弦相似度** $\operatorname{sim}_{u v}=\frac{ \mid N(u) \mid  \cap \mid N(v) \mid }{\sqrt{ \mid N(u) \mid  \cdot \mid N(v) \mid }}$ , $\operatorname{sim}_{u v}=\cos (u, v)=\frac{u \cdot v}{ \mid u \mid  \cdot \mid v \mid }$ 
