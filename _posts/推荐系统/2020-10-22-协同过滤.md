...
- **余弦相似度** $\operatorname{sim}_{u v}=\frac{|N(u) \mid  \cap|N(v) \mid }{\sqrt{ \mid N(u) \mid  \cdot \mid N(v) \mid }}$ , $\operatorname{sim}_{u v}=\cos (u, v)=\frac{u \cdot v}{ \mid u \mid  \cdot \mid v \mid }$ 
